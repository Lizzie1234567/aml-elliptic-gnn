from torch_geometric.nn import GCNConv, GATConv, SAGEConv, ChebConv,GIN,GINConv,global_mean_pool
from torch.nn import Module, Linear,Sequential,ReLU,ModuleList,Dropout
